...
namespace TGC.Group.Model
{
    class CamaraPersonal : TgcCamera //por ahora no tiene ningun cambio. mas adelante tendra que adaptarse al piso cuando se mueve.
    {
        ...
        /// <param name="input"></param>
        public CamaraPersonal(TGCVector3 positionEye, float moveSpeed, float jumpSpeed, TgcD3dInput input)
        ...
        /// <param name="input"></param>
        public CamaraPersonal(TGCVector3 positionEye, float moveSpeed, float jumpSpeed, float rotationSpeed, TgcD3dInput input)
